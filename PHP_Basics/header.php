    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
            ...
            $class = 'text-yellow';
            require 'menu.php';
            // require_once './exoHtmlPhp/fonctionsMenu.php';
            ?>
            
            
          <!-- <li><a href="/index.php" class="nav-link px-2 text-secondary <?php if( $_SERVER['SCRIPT_NAME'] === '/index.php'): ?>text-white<?php endif; ?> ">Home</a></li>
          <li><a href="/contact.php" class="nav-link px-2 text-secondary <?php if( $nav === 'contact'): ?>text-white<?php endif; ?> ">Contact</a></li> -->
        </ul>
